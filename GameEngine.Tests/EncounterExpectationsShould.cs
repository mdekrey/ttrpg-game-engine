    ...
    public class EncounterExpectationsShould
    {
        ...
        public async Task MeetAverageEncounterLengthForSingleMonster()
        {
            ...
            var pcBonusDamagePerRound = 
                await ParseToDamage(scope, pc, goblin, @"{ ""target"": { ""melee"": {}, ""effect"": { ""attack"": { ""hit"": { ""damage"": { ""amount"": ""2[W] + STR"" } } } } } }");
            var pcStandardDamagePerRound = 
                await ParseToDamage(scope, pc, goblin, @"{ ""target"": { ""melee"": {}, ""effect"": { ""attack"": { ""hit"": { ""damage"": { ""amount"": ""[W] + STR"" } } } } } }");
        ...
        public async Task MeetAverageEncounterLengthForSingleMonsterAsRanger()
        {
            ...
            var pcBonusDamagePerRound =
                await ParseToDamage(scope, pc, goblin, @"{ ""target"": { ""melee"": {}, ""effect"": { ""attack"": { ""hit"": { ""damage"": { ""amount"": ""2[W] + d6 + STR"" } } } } } }");
            var pcStandardDamagePerRound =
                await ParseToDamage(scope, pc, goblin, @"{ ""all"": [
                    { ""target"": { ""melee"": {}, ""effect"": { ""attack"": { ""bonus"": 1, ""hit"": { ""damage"": { ""amount"": ""[W] + d6"" } } } } } },
                    { ""target"": { ""melee"": {}, ""effect"": { ""attack"": { ""bonus"": 1, ""hit"": { ""damage"": { ""amount"": ""[W] - 1"", ""comment"": ""secondary weapon, hence -1"" } } } } } }
                ] }");
            var damage = GenerateDamagePerAction(new[] { (1, pcBonusDamagePerRound) }, pcStandardDamagePerRound);
        ...
        public async Task MeetAverageEncounterLengthForSingleMonsterAsRangerWithCarefulAttack()
        {
            ...
            var pcBonusDamagePerRound =
                await ParseToDamage(scope, pc, goblin, @"{ ""target"": { ""melee"": {}, ""effect"": { ""attack"": { ""hit"": { ""damage"": { ""amount"": ""2[W] + d6 + STR"" } } } } } }");
            var pcStandardDamagePerRound =
                await ParseToDamage(scope, pc, goblin, @"{ ""target"": { ""melee"": {}, ""effect"": { ""attack"": { ""bonus"": 3, ""hit"": { ""damage"": { ""amount"": ""[W] + d6 + STR"" } } } } } }");
            var damage = GenerateDamagePerAction(new[] { (1, pcBonusDamagePerRound) }, pcStandardDamagePerRound);
        ...
        public async Task MeetAverageEncounterLengthForPartyOf4()
        {
            ...
            var pcBonusDamagePerRound = 
                await ParseToDamage(scope, pc, goblin, @"{ ""target"": { ""melee"": { ""targetCount"": 2 }, ""effect"": { ""attack"": { ""hit"": { ""damage"": { ""amount"": ""[W] + STR"" } } } } } }");
            var pcStandardDamagePerRound = 
                await ParseToDamage(scope, pc, goblin, @"{ ""target"": { ""melee"": {}, ""effect"": { ""attack"": { ""hit"": { ""damage"": { ""amount"": ""[W] + STR"" } } } } } }");
