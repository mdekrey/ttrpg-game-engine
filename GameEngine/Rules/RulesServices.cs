        ...
        public static IServiceCollection AddGameEngineRules(this IServiceCollection services)
        {
            ...
            services.AddScoped(sp =>
            {
                ...
                return result
                    ...
                    .AddEffect<DamageEffect>(outcome => outcome.DamageTypes.Sum(damage => damage.Amount.With(CombatExpectations.averagePrimaryWeaponDieCode, actor.Current.Abilities).Mean()))
