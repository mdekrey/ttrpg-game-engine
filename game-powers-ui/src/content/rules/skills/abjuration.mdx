...
| ------ | ----------- | -- |
| Ward an area (radius 20') with an audible alarm | Minor Action | 12 |
| Ward an area (radius 20') against being entered by a type of creature | Minor Action | 15 |
| Secure a door or container against being opened (+10 DC) | Minor Action | 15 |
| Protect a creature from attacks against a type of creature (+2 to one defense) | Minor Action | 12 |
