...
specific person (crafting DC 20) would be DC 192. This can be reduced to a DC 20
check for {new Intl.NumberFormat('en-US').format(192 * (192 - 20) * 100)} gp. If
the conjurer also were a master sculptor, the base DC would be 152 with an
additional DC 20 crafting check, which could be reduced to a DC 20 check for
{' ' + new Intl.NumberFormat('en-US').format(142 * (142 - 20) * 100)} gp. Either way,
