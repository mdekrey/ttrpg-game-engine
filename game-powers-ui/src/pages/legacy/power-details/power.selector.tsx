		...
		<Sidebar
			sidebar={
				<>
					...
					{details ? (
						<>
							<Sidebar.Buttons.CopyText toCopy={foundry4e(details)}>To Foundry</Sidebar.Buttons.CopyText>
							<Sidebar.Buttons.DownloadText toDownload={foundry4e(details)} fileName={`power-${details.name}.json`}>
								To Foundry
...
function foundry4e(details: LegacyPowerDetails) {
