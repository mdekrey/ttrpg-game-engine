	...
	return (
		<Monsters>
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature name="Combat Advantage">
					The dire wolf gains combat advantage against a target that has one or more of the dire wolf’s allies adjacent
					to it. If the dire wolf has combat advantage against the target, the target is also knocked prone on a hit.
				</MonsterBlock.Feature>
				<MonsterBlock.Feature
					name="Pack Hunter"
					notes="(while mounted by a friendly rider of 5th level or higher; at-will)"
					keywords="Mount">
					The dire wolf’s rider gains combat advantage against an enemy if it has at least one ally other than its mount
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature type="Ranged" name="Toxic Spikes" notes="(standard; recharge ⚄ ⚅)" keywords="Poison">
					The kruthik makes 2 attacks against two different targets: ranged 5; +7 vs. AC; 1d8 + 4 damage, and the target
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature name="Acid Blast" notes="(standard; at-will)" keywords="Acid">
					Close blast 5; targets enemies; +9 vs. Fortitude; 1d6 + 4 acid damage, and the target takes ongoing 5 acid
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature name="Combat Advantage">
					The kobold skirmisher deals an extra 1d6 damage on melee and ranged attacks against any target it has combat
					advantage against.
				</MonsterBlock.Feature>
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature name="Special Shot">
					The kobold slinger can fire special ammunition from its sling. It typically carries 3 rounds of special shot,
					chosen from the types listed below. A special shot attack that hits deals normal damage and has an additional
					effect depending on its type:
					<br />
					<span className="font-bold">Stinkpot:</span> The target takes a –2 penalty to attack rolls (save ends).
					<br />
					<span className="font-bold">Firepot (Fire):</span> The target takes ongoing 2 fi re damage (save ends).
					<br />
			...
			<MonsterBlock>
				<MonsterBlock.Heading
					...
					Speed="6"
				/>
				<MonsterBlock.Feature type="MeleeBasic" name="Short Sword" notes="(standard; at-will)" keywords="Weapon">
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature type="Close" name="Dragon Breath" notes="(standard; encounter)">
					Close blast 3; +6 vs. Fortitude; 1d10 + 3 damage of a chosen type (based on the dragon served). Miss: Half
					damage.
				</MonsterBlock.Feature>
				<MonsterBlock.Feature name="Shifty" notes="(minor; at-will)">
					The kobold shifts 1 square.
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature type="Melee" name="Twin Slash" notes="(standard; at-will)" keywords="Weapon">
					Requires combat advantage; the kobold slyblade makes 2 short sword attacks. If both attacks hit the same
					target, the target takes ongoing 5 damage (save ends).
				</MonsterBlock.Feature>
				<MonsterBlock.Feature name="Combat Advantage">
					The kobold skirmisher deals an extra 1d6 damage on melee and ranged attacks against any target it has combat
					advantage against.
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature type="Melee" name="Dazing Strike" notes="(standard; encounter)" keywords="Weapon">
					Requires mace; +4 vs. AC; 1d8 + 1 damage, the target is dazed until the end of the human bandit’s next turn,
					and the human bandit shifts 1 square.
				</MonsterBlock.Feature>
				<MonsterBlock.Feature name="Combat Advantage">
					The human bandit deals an extra 1d6 damage on melee and ranged attacks against any target it has combat
					advantage against.
				</MonsterBlock.Feature>
				<MonsterBlock.Trailing
					Str={+2}
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature name="Mob Rule">
					The human rabble gains a +2 power bonus to all defenses while at least two other human rabble are within 5
					squares of it.
				</MonsterBlock.Feature>
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature name="Mob Rule">
					The human lackey gains a +2 power bonus to all defenses while at least two other human rabble are within 5
					squares of it.
				</MonsterBlock.Feature>
				<MonsterBlock.Trailing Str={+6} Dex={+3} Wis={+4} Con={+5} Int={+3} Cha={+4} Equipment="leather armor, club" />
			</MonsterBlock>
			<MonsterBlock>
				<MonsterBlock.Heading
					name="Human Guard"
				...
				<MonsterBlock.Feature type="Melee" name="Powerful Strike" notes="(standard; recharge ⚄ ⚅)" keywords="Weapon">
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature type="Melee" name="Battle Fury" notes="(free, when first bloodied; encounter)">
					The human berserker makes a melee basic attack with a +4 bonus to the attack roll and deals an extra 1d6
					damage on a hit.
				</MonsterBlock.Feature>
				<MonsterBlock.Trailing
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature type="MeleeBasic" name="Sting" notes="(standard; recharge ⚃ ⚄ ⚅)" keywords="Poison">
				...
				<MonsterBlock.Feature type="Melee" name="Flyby Attack" notes="(standard; at-will)">
					The pseudodragon fl ies up to 8 squares and makes one melee basic attack at any point during that movement.
					The pseudodragon doesn’t provoke opportunity attacks when moving away from the target of the attack.
				</MonsterBlock.Feature>
				<MonsterBlock.Feature
					type="Melee"
					name="Invisibility"
				...
				<MonsterBlock.Trailing Skills="Insight +8, Stealth +10" Str={+2} Dex={+5} Wis={+3} Con={+4} Int={-1} Cha={+4} />
			</MonsterBlock>
			<MonsterBlock>
				<MonsterBlock.Heading
					name="Spitting Drake"
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature type="Close" name="Acidic Cloud" notes="(standard; encounter)" keywords="Acid, Zone">
					Close burst 4; the burst creates a zone of caustic gas that lasts until the end of the encounter. Any enemy
					that starts its turn within the zone takes 2 acid damage for each giant ant within the zone. The zone is
					centered on the hive queen and moves with her.
				</MonsterBlock.Feature>
				<MonsterBlock.Feature type="Area" name="Acidic Blast" notes="(standard; recharge ⚃ ⚄ ⚅)" keywords="Acid">
					Area burst 3 within 10; targets enemies; +7 vs. Will; 1d6 + 2 acid damage, and the target is dazed (save
					ends). Miss: Half damage.
				</MonsterBlock.Feature>
				<MonsterBlock.Feature name="Call to Arms" notes="(when first bloodied; encounter)">
					Four new giant ant hive workers appear and act to defend their queen. Each ant appears within 5 squares of the
					hive queen, and acts on the queen’s initiative count.
				</MonsterBlock.Feature>
			...
			<MonsterBlock>
				...
				/>
				<MonsterBlock.Feature type="MeleeBasic" name="Piercing Bite" notes="(standard; at-will)" keywords="Acid">
					+7 vs. AC; 1d8 + 4 damage. The hive warrior’s attack deals 1d10 extra acid damage to any target that already
					has ongoing acid damage.
				</MonsterBlock.Feature>
				<MonsterBlock.Feature
					type="Melee"
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature type="Melee" name="Acid Sting" notes="(standard; at-will)">
					Targets a creature grabbed by the hive soldier; +10 vs. AC; 1d6 + 3 acid damage, and ongoing 5 acid damage
					(save ends).
				</MonsterBlock.Feature>
				<MonsterBlock.Feature
					type="Close"
			...
			<MonsterBlock>
				...
				<MonsterBlock.Feature type="Melee" name="Flyby Attack" notes="(standard; at-will)">
					The winged drone flies 8 squares and makes one acid sting at any point during that movement. The drone doesn’t
					provoke opportunity attacks when moving away from the target of the attack.
				</MonsterBlock.Feature>
				<MonsterBlock.Feature
					type="Close"
					name="Shredding Wings"
					notes="(standard; usable only while bloodied; encounter)">
					Close blast 2; +8 vs. AC; 3d6 + 4 damage, and the winged drone loses its fly speed until the end of the
					encounter.
				</MonsterBlock.Feature>
